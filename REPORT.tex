...
\hypersetup{colorlinks=true,linkcolor=NavyBlue,urlcolor=NavyBlue,citecolor=NavyBlue,
  pdftitle={\coursecode\ Final Project Report},pdfauthor={\teamname}}
\pagestyle{fancy}
\fancyhf{}
...
\textbf{Members:} & \multicolumn{3}{X@{}}{\small%
  \mbox{\member{Günəş Məmmədova}{\href{https://github.com/Gunas12}{@Gunas12}}},\quad
  \mbox{\member{Esmira Məmmədova}{\href{https://github.com/EsmiraMammadli}{@EsmiraMammadli}}},\newline
  \mbox{\member{Əli Muradov}{\href{https://github.com/Ali-Muradov}{@Ali-Muradov}}},\quad
  \mbox{\member{Pünhan Mürsəlov}{\href{https://github.com/Punhan0}{@Punhan0}}}
}\\
\end{tabularx}
